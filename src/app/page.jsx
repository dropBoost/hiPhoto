...
export default function Home() {
  return (
    ...
    <div className="flex flex-col bg-white h-screen w-screen">
      ...
      <div id="body" className=" bg-stone-100 flex flex-1 justify-center items-center lg:p-20 p-10">
        <div className="grid grid-cols-12 lg:grid-rows-2 grid-rows-11 lg:h-[50vh] h-[70vh] w-screen gap-5">
          ...
          <div className="flex lg:justify-start lg:items-start justify-center items-center lg:col-span-3 lg:row-span-1 lg:col-start-4 lg:row-start-1 col-span-6 row-span-3 col-start-7 row-start-1 bg-stone-200/50">
            <p className="font-playfair text-playfair text-stone-500 xl:text-[1rem] md:text-[0.9rem] text-[0.75rem] font-500 p-5">
              Da oltre quarant’anni, raccontiamo storie con la luce, catturiamo emozioni attraverso l’obiettivo e trasformiamo attimi irripetibili in ricordi senza tempo.
            </p>
          </div>
          <div className="flex justify-center items-center lg:col-span-3 lg:row-span-1 lg:col-start-7 lg:row-start-1 col-span-6 row-span-1 col-start-7 row-start-4  font-playfair text-md font-light p-4 bg-red-700">
          ...
          <div className="flex justify-center items-center p-4 font-playfair text-md font-light lg:col-span-1 lg:row-span-1 lg:col-start-12 lg:row-start-2 col-span-6 row-span-1 col-start-7 row-start-11 bg-red-700 ">
